        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoogleSubjectId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceAlerts_AppUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceAlerts_UserId_AssetId_IsActive",
                table: "PriceAlerts",
                columns: new[] { "UserId", "AssetId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_PriceHistories_AssetId_CapturedAt",
